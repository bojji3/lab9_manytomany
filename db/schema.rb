...
ActiveRecord::Schema[7.1].define(version: 2024_05_18_111209) do
  ...
  create_table "book_libraries", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "book_id", null: false
